...
public class UserUtils {
	...
	public void initDb() {
		...
		user.setPromotionDate(new Date());
		...
		user2.setPromotionDate(new Date());
		...
		user4.setState("active");
		user4.setPromotionDate(new Date());
